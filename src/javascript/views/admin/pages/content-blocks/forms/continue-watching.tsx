...
interface Props {
  ...
  onSubmit: (block: ContinueWatchingBlock, index?: number) => void
}

export interface ContinueWatchingBlock {
  title: string
  background: string
}

const ContinueWatchingBlockForm: React.FC<Props> = (props) => {
  const {
    block,
...
export default ContinueWatchingBlockForm
...
interface Props {
  ...
  onSubmit: (block: MostPopularBlock, index?: number) => void
}

export interface MostPopularBlock {
  title: string
  background: string
}

const MostPopularBlockForm: React.FC<Props> = (props) => {
  const {
    block,
...
export default MostPopularBlockForm